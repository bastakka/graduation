...
\begin{enumerate}
  ...
  \item \hyperref[sec:aritmeticke-operace]{Aritmetické operace v počítači (operace s celými a racionálními čísly, součet/rozdíl, násobení/dělení, základní algoritmy)}
  \item \hyperref[sec:fw-a-ochrana-tcp-ip]{FW a ochrany jednotlivých vrstev TCP/IP (principy funkčnosti a nastavení, praktické příklady realizace)}
...
\include{TVY-POS/ISO-OSI-TCP-IP/ISO-OSI-TCP-IP.tex}
\include{TVY-POS/Polovodicove-pameti/Polovodicove-pameti.tex}
\include{TVY-POS/VLAN/VLAN.tex}
\include{TVY-POS/Ciselne-soustavy/Ciselne-soustavy.tex}
\include{TVY-POS/Fyzicka-vrstva/Fyzicka-vrstva.tex}
\include{TVY-POS/EEPROM-FLASH-SSD/EEPROM-FLASH-SSD.tex}
\include{TVY-POS/Linkova-vrstva/Linkova-vrstva.tex}
\include{TVY-POS/Adresne-mody-CPU/Adresne-mody-CPU.tex}
\include{TVY-POS/Sitova-vrstva/Sitova-vrstva.tex}
\include{TVY-POS/Motherboard/Motherboard.tex}
\include{TVY-POS/Opticka-zarizeni/Opticka-zarizeni.tex}
\include{TVY-POS/IPv4-adresace/IPv4-adresace.tex}
\include{TVY-POS/Moderni-CPU/Moderni-CPU.tex}
\include{TVY-POS/Podsite-IPv4/Podsite-IPv4.tex}
\include{TVY-POS/Logicke-cleneni-pameti/Logicke-cleneni-pameti.tex}
\include{TVY-POS/IPv6-adresace/IPv6-adresace.tex}
\include{TVY-POS/Preruseni-CPU/Preruseni-CPU.tex}
\include{TVY-POS/Dynamicke-smerovaci-protokoly/Dynamicke-smerovaci-protkoly.tex}
\include{TVY-POS/Laserove-a-LED-tiskarny/Laserove-a-LED-tiskarny.tex}
\include{TVY-POS/Rozdeleni-siti/Rozdeleni-siti.tex}
\include{TVY-POS/Vystupni-zobrazovaci-zarizeni/Vystupni-zobrazovaci-zarizeni.tex}
\include{TVY-POS/Hrozby-na-siti/Hrozby-na-siti.tex}
\include{TVY-POS/Aritmeticke-operace/Aritemeticke-operace.tex}
\include{TVY-POS/FW-a-ochrana-TCP-IP/FW-a-ochrana-TCP-IP.tex}
\include{TVY-POS/Vstupni-zarizeni/Vstupni-zarizeni.tex}
\end{document}
